    ...
    value: function sort() {
      ...
      var animate = function animate() {
        ...
        if (_this.isSorted(_this.array)) {
          ...
          setTimeout(animate, speed); // console.log(this.array);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        console.log(arr);
                        return _context3.delegateYield(arr, "t0", 4);
            ...
            case 4:
              ...
              return _context4.delegateYield(merge(sortedLeft, sortedRight), "t0", 10);
